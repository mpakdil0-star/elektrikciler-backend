    ...
    legalDocuments = [
        {
            ...
            content: 'Veri Sorumlusu: Mustafa Pakdil (Bireysel Geliştirici)\\n\\n1. İŞLEME AMACI: Kişisel verileriniz, 6698 sayılı KVKK kapsamında sadece platformun çalışması, usta-müşteri eşleşmesi ve güvenliğin sağlanması amacıyla işlenir.\\n2. VERİ KONUSU KİŞİLER: Uygulama kullanıcısı olan hizmet verenler (ustalar) ve hizmet alan vatandaşlar.\\n3. SORUMLULUK: Uygulama sahibi, kullanıcılar arasındaki iletişimi sağlayan teknik altyapıyı sunmaktadır. Tarafların birbirine sağladığı verilerin doğruluğundan uygulama sahibi sorumlu değildir.\\n4. HAKLARINIZ: KVKK Madde 11 uyarınca mpakdil0@gmail.com adresi üzerinden verilerinize erişme ve silme talebinde bulunabilirsiniz.',
            isActive: true,
        ...
        },
        {
            ...
            content: '1. ARACI ROLÜ: Bu uygulama, usta ve vatandaşları bir araya getiren bir dijital pazar yeridir. Geliştirici, "Yer Sağlayıcı" statüsündedir.\\n2. SORUMLULUK SINIRLANDIRILMASI: İşbu platform sadece bir iletişim köprüsü olup; sunulan hizmetin kalitesi, gecikmesi, eksikliği veya taraflar arasındaki maddi/manevi hiç bir uyuşmazlıktan uygulama sahibi sorumlu tutulamaz.\\n3. SÖZLEŞME TARAFSIZLIĞI: Hizmet ilişkisi doğrudan usta ile vatandaş arasındadır. Ödeme, garanti ve iş teslimi süreçleri tamamen tarafların kendi sorumluluğundadır.\\n4. GÜVENLİK: Kullanıcılar kendi güvenliklerinden sorumludur. Uygulama sahibi, usta veya vatandaşların kimlik doğruluğunu veya geçmişini garanti etmez.',
            isActive: true,
            updatedAt: new Date().toISOString()
        },
        {
